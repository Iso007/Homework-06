...
// run function to pull cities from local and fill array with it
function init(){
...
// set localstorage item to cities array
...
function searchClicker(){
    $("#searchbtn").on("click", function(event){
        ...
        // push city user into cities array
        cities.push(city);
...
// runs 2 API calls, one for the 5 day forecast, then populates text areas
function APIcalls(){
    ...
    $.ajax({
        ...
        $("#today_icon_div").attr({"src:": "http://openweather.org/img/w/" + current_data.weather[0].icon + ".png",
